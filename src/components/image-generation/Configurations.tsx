...
const formSchema = z.object({
   ...
   num_interfrence_steps : z.number().min(1, {message: "Number of inference step should be atleast 1."}).max(50, {message: "Number of inference step must be or equal to 50."}),
})
